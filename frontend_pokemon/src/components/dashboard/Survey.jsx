...
export default function Survey(){
  ...
  return (
    <div>
      <h2>What describes your current mood?</h2>
      
      {/* Survey form */}
      <form onSubmit={handleSubmit}>
        <div>{Object.keys(moodToPokemonType).map((mood) => (
            <label key={mood}>
              <input
                type="radio"
                name="mood"
      ...
      {pokemon && (
        <div>
          <img src={pokemon.sprites.other.home.front_default} alt={pokemon.name} style={{ width: '250px', height: 'auto' }}/>
